...
import {
  ...
  Download, Filter, Bell, Mail, Send, CheckCircle2, LogOut,
} from "lucide-react";
...
export default function AdminPage() {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Cookie may already be gone — still navigate to the login screen.
    }
  ...
  return (
    <div className="min-h-screen flex bg-ascend-black">
      ...
      <aside className="hidden lg:flex w-64 flex-shrink-0 bg-ascend-black border-r border-white/5 flex-col fixed top-0 bottom-0 z-30">
        ...
        <div className="p-4 border-t border-white/5">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 text-sm font-heading uppercase tracking-wider text-ascend-gray hover:text-red-400 transition-colors"
          >
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-ascend-black border-b border-white/5 z-40 flex overflow-x-auto">
        ...
        <button
          onClick={handleLogout}
          className="flex items-center gap-2 px-4 py-3 text-xs font-heading uppercase tracking-wider whitespace-nowrap text-red-400"
        >
